...
PEDIDO_ORIGEM_VALUES = ("WEB", "MOBILE", "BACKOFFICE")
PEDIDO_ORIGEM_NAME = "pedidoorigem"
SERVICO_TIPO_VALUES = ("PRESENCIAL", "ONLINE", "DOMICILIO", "MISTO")
SERVICO_TIPO_NAME = "servicotipoatendimento"
...
def upgrade() -> None:
    ...
    pedido_origem_enum = sa.Enum(*PEDIDO_ORIGEM_VALUES, name=PEDIDO_ORIGEM_NAME)
    pedido_origem_enum.create(op.get_bind(), checkfirst=True)
    servico_tipo_enum = sa.Enum(*SERVICO_TIPO_VALUES, name=SERVICO_TIPO_NAME)
    servico_tipo_enum.create(op.get_bind(), checkfirst=True)
    op.add_column('agendamentos', sa.Column('preco_confirmado', sa.Numeric(precision=10, scale=2), nullable=True))
    op.add_column('agendamentos', sa.Column('endereco_atendimento', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    op.add_column(
        'agendamentos',
        sa.Column(
            'canal',
            sa.Enum(*PEDIDO_ORIGEM_VALUES, name=PEDIDO_ORIGEM_NAME, create_type=False),
            nullable=False,
        ),
    )
    ...
    op.add_column('clientes', sa.Column('default_address_id', GUID(), nullable=True))
    op.add_column('clientes', sa.Column('metadata_extra', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    op.add_column('itens_pedido', sa.Column('nome_snapshot', sa.String(length=255), nullable=True))
    op.add_column('itens_pedido', sa.Column('merchant_id', GUID(), nullable=True))
    op.add_column('itens_pedido', sa.Column('prestador_id', GUID(), nullable=True))
    op.add_column('itens_pedido', sa.Column('categoria_id_snapshot', GUID(), nullable=True))
    ...
    op.add_column('merchants', sa.Column('horario_funcionamento', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    op.add_column('merchants', sa.Column('pedido_minimo', sa.Numeric(precision=10, scale=2), nullable=False, server_default='0'))
    op.add_column('merchants', sa.Column('tempo_medio_preparacao_min', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('merchants', sa.Column('aceita_produtos', sa.Boolean(), nullable=False, server_default=sa.text('true')))
    op.add_column('merchants', sa.Column('aceita_servicos', sa.Boolean(), nullable=False, server_default=sa.text('true')))
    op.add_column('merchants', sa.Column('ativo', sa.Boolean(), nullable=False, server_default=sa.text('true')))
    ...
    op.add_column('pedidos', sa.Column('endereco_entrega_snapshot', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    ...
    op.add_column('prestadores', sa.Column('avaliacao_media', sa.Numeric(precision=3, scale=2), nullable=False, server_default='0'))
    op.add_column('prestadores', sa.Column('total_avaliacoes', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('prestadores', sa.Column('zona_atendimento', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    op.add_column('prestadores', sa.Column('atende_ao_domicilio', sa.Boolean(), nullable=False, server_default=sa.text('false')))
    op.add_column('prestadores', sa.Column('atende_online', sa.Boolean(), nullable=False, server_default=sa.text('false')))
    op.add_column('prestadores', sa.Column('linguas', sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")))
    op.add_column('prestadores', sa.Column('ativo', sa.Boolean(), nullable=False, server_default=sa.text('true')))
    ...
    op.add_column('produtos', sa.Column('stock_atual', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('produtos', sa.Column('stock_minimo', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('produtos', sa.Column('categoria_id', GUID(), nullable=True))
    op.add_column('produtos', sa.Column('imagens', sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")))
    op.add_column('produtos', sa.Column('atributos_extras', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    op.add_column('produtos', sa.Column('permitir_backorder', sa.Boolean(), nullable=False, server_default=sa.text('false')))
    op.add_column('produtos', sa.Column('max_por_pedido', sa.Integer(), nullable=True))
    op.add_column('produtos', sa.Column('ativo', sa.Boolean(), nullable=False, server_default=sa.text('true')))
    ...
    op.add_column('servicos', sa.Column('categoria_id', GUID(), nullable=True))
    op.add_column('servicos', sa.Column('imagens', sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")))
    op.add_column('servicos', sa.Column('tags', sa.JSON(), nullable=False, server_default=sa.text("'[]'::json")))
    op.add_column('servicos', sa.Column('politica_cancelamento', sa.Text(), nullable=True))
    op.add_column(
        'servicos',
        sa.Column(
            'tipo_atendimento',
            sa.Enum(*SERVICO_TIPO_VALUES, name=SERVICO_TIPO_NAME, create_type=False),
            nullable=False,
            server_default='PRESENCIAL',
        ),
    )
    op.add_column('servicos', sa.Column('ativo', sa.Boolean(), nullable=False, server_default=sa.text('true')))
    ...
    op.add_column('tenants', sa.Column('moeda_padrao', sa.String(length=10), nullable=False, server_default='EUR'))
    op.add_column('tenants', sa.Column('config_checkout', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
    op.add_column('tenants', sa.Column('branding', sa.JSON(), nullable=False, server_default=sa.text("'{}'::json")))
...
def downgrade() -> None:
    ...
    # ### end Alembic commands ###
    sa.Enum(*SERVICO_TIPO_VALUES, name=SERVICO_TIPO_NAME).drop(op.get_bind(), checkfirst=True)
    sa.Enum(*PEDIDO_ORIGEM_VALUES, name=PEDIDO_ORIGEM_NAME).drop(op.get_bind(), checkfirst=True)
